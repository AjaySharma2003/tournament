   ...
   <div class="wrapper">
    ...
    <form action="#" method="post" class="form-block" autocomplete="on">
        ...
        <div class="form-group">
            ...
            <input type="email" name="user_mail" class="form-control" value="<?php echo $user_mail;?>" required>
        </div>
        <div class="form-group">
    ...
    <center>
    <a href="user_login.php" class="letter-design"><strong>Already have an account?</strong></a><br>
   </center>
    </div>
   </div>
...
if(isset($_POST["register"]))
{
    ...
    $password = $_POST["password"];
    $c_password = $_POST["c_password"];
    $sql = "SELECT user_mail from users WHERE user_mail='$user_mail'";
    ...
    {
        $sql = "INSERT INTO users(user_name, user_mail, mobile_number, password) VALUES('$user_name','$user_mail',$mobile_number ,'$password')";
        $result = mysqli_query($conn, $sql);
        if($result)
        {
