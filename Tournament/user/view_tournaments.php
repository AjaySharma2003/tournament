...
<head>
    ...
    <title>Upcomming Tournaments</title>
    <style>
        body{
            height: 100%;
   ...
   <div class="wrapper">
    ...
    <div class="card-block" style="margin-left:00px;">
        ...
        <div class="last-element">
          ...
          <div class="">
            <a href="registration.php?tournament_id=<?php echo $tournament_id;?>"class="button-47">Register</a>
          </div>
        </div>
      </div></div>
    <?php }?>
...
$sql = "SELECT * FROM tournaments WHERE status != 1 ORDER BY tournament_id DESC";
