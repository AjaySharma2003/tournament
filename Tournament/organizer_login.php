   ...
   <div class="wrapper">
    ...
    <form action="#" method="post" class="form-block" autocomplete="on">
        ...
        <div class="form-group" align="center">
            <input type="submit" name="organizer_login" class="button-34" role="button" value="Login" >
        </div>
        </div>
    </form>
    <center>
    <a href="organizer_registration.php" class="letter-design"><strong>Need an account?</strong></a><br>
   </center>
</div>
   </div>
...
if(isset($_POST["organizer_login"]))
{
    ...
    $sql = "SELECT * FROM organizers WHERE organizer_mail='$organizer_mail'";
    ...
    {
        session_start();
        $_SESSION["organizer_mail"] = $organizer_mail;
         header('location:organizer/add_tournament.php');
    }
    else{
