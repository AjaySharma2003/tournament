...
<nav>
   ...
   <div class="tournament-detail-wrapper">
    <h3 class="form-head" align="center">Tournament Detail</h3>
    <div class="go-back">
    <a href="my_tournaments.php" class="button-47">Go Back</a>
        ...
        if($status == 0)
        {?>
        <a href="update_tournament.php?tournament_id=<?php echo $tournament_id;?>"class="button-62" >Update</a>
        <?php }?>
        <a href="view_teams.php?tournament_id=<?php echo $tournament_id;?>"class="button-62" >View Teams</a>
        </div>
</div>
