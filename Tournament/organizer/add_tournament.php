...
if(isset($_POST["add_tournament"]))
{
    ...
    $sql = "INSERT INTO tournaments(tournament_name,organizer,game,category,gender,venue,landmark,place,district,state,country,date,first_price,second_price,third_price,additional_price, entrance_fees, rules, about_event, about_organizer, contact_details, organizer_mail,image)
    VALUES('$tournament_name','$organizer','$game','$category','$gender','$venue','$landmark','$place','$district','$state','$country','$date',$first_price,$second_price,$third_price, '$additional_price' ,$entrance_fees, '$rules', '$about_event', '$about_organizer', '$contact_details', '$organizer_mail','$image')";
